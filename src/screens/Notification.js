    ...
    return(
        <ScrollView className="w-full">
            ...
            <View className="px-8">
                ...
                {/* <View className="container flex flex-row items-center mt-4 bg-blue-300 rounded-lg ">
                    <Ionicons
                        name="information-circle-outline"
                        size={30}
                        className="ml-2 mr-4 text-black"
                    />
                    <Text className="text-lg text-black pr-16">Lorem ipsum dolor sit amet consectetur. 
