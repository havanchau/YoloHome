...
export default Splash = () => {
    ...
    return (
      <View className='flex-1 items-center pb-10'>
        ...
        <TouchableOpacity onPress={handlePress2} className='py-4 px-8 bg-bluebg rounded-3xl w-[150]  flex items-center'><Text className='text-xl text-white'>Sign Up</Text></TouchableOpacity>
      </View>
  );
};
